...
function buildGeminiSystemPrompt(cr, isf, ctx) {
    ...
    return "אתה עוזר טיפולי לניהול סוכרת סוג 1.\n" +
        ...
        "(המשאבה מנכה IOB=" + iob + "U ומעבירה את היתרה ל-SMB/בזאלי זמני לאורך הספיגה — הגנה מהיפו בשעה הראשונה.)\n" +
        "\n" +
        "🧠 למה פחות פחמימות מראש?\n" +
        "אם היית מזין [X]g, הלופ היה מציע ~[X÷CR−IOB]U מיידית — מנה כבדה מדי על מאכל [שומני/איטי]. בשילוב עם השומן שמעכב הספיגה, זה עלול לגרום להיפו בשינה. לכן מפצלים ומנהלים את היתרה בבטחה.\n" +
        "\n" +
        "⏳ תזמון: " + timing + "\n" +
        "\n" +
        "🛡️ תוכנית המשך ([Z]g חוב):\n" +
        "[Z]g נותרים כחוב לוגי ברקע. המערכת מנטרת ותשלח התראת פוש בזמן אמת — מתי להזין את היתרה ללופ וכמה גרמים בהתאם למצב החי.\n" +
        "\n" +
